  ...
  const regions = await Promise.all([
    prisma.region.upsert({
      ...
      create: {
        ...
        imageUrl: "/images/regions/cameroon-west.jpg",
        isPublished: true,
      },
    }),
    prisma.region.upsert({
      ...
      create: {
        ...
        imageUrl: "/images/regions/cameroon-northwest.jpg",
        isPublished: true,
      },
    }),
    prisma.region.upsert({
      ...
      create: {
        ...
        imageUrl: "/images/regions/ghana-ashanti.jpg",
        isPublished: true,
      },
    }),
    prisma.region.upsert({
      ...
      create: {
        ...
        imageUrl: "/images/regions/mali-dogon.jpg",
        isPublished: true,
      },
    }),
  ]);
  ...
  const symbols = await Promise.all([
    ...
    prisma.symbol.upsert({
      ...
      create: {
        ...
        images: ["/images/symbols/ndop-spider-1.jpg", "/images/symbols/ndop-spider-2.jpg"],
        category: "ANIMAL",
    ...
    prisma.symbol.upsert({
      ...
      create: {
        ...
        images: ["/images/symbols/ndop-double-gong.jpg"],
        category: "OBJECT",
    ...
    prisma.symbol.upsert({
      ...
      create: {
        ...
        images: ["/images/symbols/ndop-lizard.jpg"],
        category: "ANIMAL",
    ...
    prisma.symbol.upsert({
      ...
      create: {
        ...
        images: ["/images/symbols/ndop-zigzag.jpg"],
        category: "GEOMETRIC",
    ...
    prisma.symbol.upsert({
      ...
      create: {
        ...
        images: ["/images/symbols/adinkra-sankofa.jpg"],
        category: "ANIMAL",
    ...
    prisma.symbol.upsert({
      ...
      create: {
        ...
        images: ["/images/symbols/adinkra-gye-nyame.jpg"],
        category: "ABSTRACT",
    ...
    prisma.symbol.upsert({
      ...
      create: {
        ...
        images: ["/images/symbols/bogolan-crocodile.jpg"],
        category: "ANIMAL",
  ...
  const pagnes = await Promise.all([
    prisma.pagne.upsert({
      ...
      create: {
        ...
        images: ["/images/pagnes/ndop-royal-bleu-1.jpg", "/images/pagnes/ndop-royal-bleu-2.jpg"],
    ...
    prisma.pagne.upsert({
      ...
      create: {
        ...
        images: ["/images/pagnes/ndop-mariage.jpg"],
    ...
    prisma.pagne.upsert({
      ...
      create: {
        ...
        images: ["/images/pagnes/kente-adweneasa.jpg"],
    ...
    prisma.pagne.upsert({
      ...
      create: {
        ...
        images: ["/images/pagnes/bogolan-chasseur.jpg"],
  ...
  await Promise.all([
    prisma.product.upsert({
      ...
      create: {
        ...
        currency: "ADA",
        type: "PHYSICAL_PAGNE",
        images: ["/images/pagnes/ndop-royal-bleu-1.jpg"],
        pagneId: pagnes[0].id,
        stock: 10,
        isAvailable: true,
        isFeatured: true,
  ...
  await Promise.all([
    prisma.event.create({
      data: {
        ...
        imageUrl: "/images/events/festival-ndop.jpg",
    ...
    prisma.event.create({
      data: {
        ...
        imageUrl: "/images/events/atelier-kente.jpg",
        location: "En ligne",
